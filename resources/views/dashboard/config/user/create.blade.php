...
<x-layouts.dashboard>
    ...
    <x-card>
        <div class="space-y-8">
            ...
            <form method="post" action="{{ route('dashboard.config.user.store') }}"
                x-data="{
                ...
                <div class="max-w-xl space-y-4">
                    ...
                    <div class="space-y-2">
                        <label
                            ...
                            <input id="is-force-password-change" type="checkbox" name="is_force_password_change" class="accent-neutral-800 dark:accent-neutral-200 disabled:pointer-events-none"
                                @if (old('is_force_password_change')) checked @endif
                        />
